...
Begin VB.Form frmMain 
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":7498
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":74BC
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":79BE
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":79E2
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":7D98
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":7DC4
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":8146
      mode            =   1
      value           =   0   'False
      image           =   "frmMain.frx":816A
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      cgradient       =   8421631
      cfore           =   0
      font            =   "frmMain.frx":B7CC
      mode            =   1
      value           =   0   'False
      image           =   "frmMain.frx":B7F0
      imgsize         =   24
      imgalign        =   5
      cfhover         =   0
      cback           =   -2147483633
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":68DB4
         Left            =   1080
         List            =   "frmMain.frx":68DC4
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":68DD4
         Left            =   120
         List            =   "frmMain.frx":68DD6
         Sorted          =   -1  'True
         TabIndex        =   47
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":68E44
         Left            =   3360
         List            =   "frmMain.frx":68E46
         TabIndex        =   43
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":68E48
         Left            =   840
         List            =   "frmMain.frx":68E4A
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":68E4C
         Left            =   120
         List            =   "frmMain.frx":68E4E
         TabIndex        =   42
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":68E50
         Left            =   840
         List            =   "frmMain.frx":68E52
         TabIndex        =   34
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":68E54
         Left            =   3360
         List            =   "frmMain.frx":68E56
         TabIndex        =   33
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":68E58
         Left            =   120
         List            =   "frmMain.frx":68E5A
         TabIndex        =   31
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":68E5C
         Left            =   120
         List            =   "frmMain.frx":68E5E
         TabIndex        =   30
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":6907C
         Left            =   840
         List            =   "frmMain.frx":6907E
         TabIndex        =   53
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":69080
         Left            =   120
         List            =   "frmMain.frx":69082
         TabIndex        =   55
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":69084
         Left            =   3360
         List            =   "frmMain.frx":69086
         TabIndex        =   56
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":69088
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":690AC
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1

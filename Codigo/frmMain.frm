...
Begin VB.Form frmMain 
   ...
   Begin VB.Frame FraInformaciónDel 
      ...
      Begin VB.TextBox txtAmbient 
         ...
         Width           =   495
      End
      Begin VB.TextBox lblMapVersion 
         Appearance      =   0  'Flat
         Height          =   285
         Left            =   840
         TabIndex        =   97
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   1
      cgradient       =   8421631
      font            =   "frmMain.frx":62F6
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":631A
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":68E0
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":6904
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":6E06
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":6E2A
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":71E0
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":720C
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":758E
      mode            =   1
      value           =   0   'False
      image           =   "frmMain.frx":75B2
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      cgradient       =   8421631
      cfore           =   0
      font            =   "frmMain.frx":AC14
      mode            =   1
      value           =   0   'False
      image           =   "frmMain.frx":AC38
      imgsize         =   24
      imgalign        =   5
      cfhover         =   0
      cback           =   -2147483633
   ...
   Begin VB.PictureBox pPaneles 
      ...
      Begin VB.ComboBox cCapas 
         ...
         ForeColor       =   &H80000014&
         Height          =   330
         ItemData        =   "frmMain.frx":6823C
         Left            =   1080
         List            =   "frmMain.frx":6824C
         TabIndex        =   1
         TabStop         =   0   'False
         Text            =   "1"
         Top             =   3120
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   0
         ItemData        =   "frmMain.frx":6825C
         Left            =   120
         List            =   "frmMain.frx":6825E
         Sorted          =   -1  'True
         TabIndex        =   61
         Tag             =   "-1"
         Top             =   120
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":682CC
         Left            =   3360
         List            =   "frmMain.frx":682CE
         TabIndex        =   57
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   2
         ItemData        =   "frmMain.frx":682D0
         Left            =   840
         List            =   "frmMain.frx":682D2
         TabIndex        =   0
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   3
         ItemData        =   "frmMain.frx":682D4
         Left            =   120
         List            =   "frmMain.frx":682D6
         TabIndex        =   56
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":682D8
         Left            =   840
         List            =   "frmMain.frx":682DA
         TabIndex        =   48
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   0
         ItemData        =   "frmMain.frx":682DC
         Left            =   3360
         List            =   "frmMain.frx":682DE
         TabIndex        =   47
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   1
         ItemData        =   "frmMain.frx":682E0
         Left            =   120
         List            =   "frmMain.frx":682E2
         TabIndex        =   45
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   3210
         Index           =   4
         ItemData        =   "frmMain.frx":682E4
         Left            =   120
         List            =   "frmMain.frx":682E6
         TabIndex        =   44
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cCantFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":68504
         Left            =   840
         List            =   "frmMain.frx":68506
         TabIndex        =   67
         Text            =   "1"
         Top             =   3120
         Visible         =   0   'False
      ...
      Begin VB.ListBox lListado 
         ...
         Height          =   2580
         Index           =   2
         ItemData        =   "frmMain.frx":68508
         Left            =   120
         List            =   "frmMain.frx":6850A
         TabIndex        =   69
         Tag             =   "-1"
         Top             =   120
         Visible         =   0   'False
      ...
      Begin VB.ComboBox cNumFunc 
         ...
         Height          =   330
         Index           =   1
         ItemData        =   "frmMain.frx":6850C
         Left            =   3360
         List            =   "frmMain.frx":6850E
         TabIndex        =   70
         Text            =   "500"
         Top             =   3120
         Visible         =   0   'False
   ...
   Begin WorldEditor.lvButtons_H SelectPanel 
      ...
      shape           =   3
      cgradient       =   8421631
      font            =   "frmMain.frx":68510
      mode            =   1
      value           =   0   'False
      customclick     =   1
      image           =   "frmMain.frx":68534
      imgsize         =   24
      imgalign        =   5
      cback           =   -2147483633
      lockhover       =   1
